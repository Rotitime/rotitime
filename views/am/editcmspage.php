    ...
    <div class="container-fluid">
      ...
      <div class="box_general padding_bottom">
        <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Edit CMS Page</h2>
        </div>
 ...
 <form method="post" id="addCms" name="addcms"  enctype="multipart/form-data">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="page_name" name="page_name" value="<?= $page_name; ?>">
    ...
    <div class="col-md-12">
		  <div class="form-group">
			...
			<textarea class="form-control editor" id="page_content" name="page_content"><?= $page_content; ?></textarea>
    ...
    <div class="col-md-6">
			<div class="form-group">
			<label for="is_active">Display In Homepage:</label><br>
    ...
    <div class="col-md-6">
			<div class="form-group">
			<label for="is_display_in_footer">Display In Homepage:</label><br>
			<input type="radio" id="is_display_in_footer" name="is_display_in_footer" value="Y" <?php if($is_display_in_footer == 'Y') { ?> checked = "checked" <?php } ?>>
			<label for="Y">Yes</label><br>

			<input type="radio" id="is_display_in_footer" name="is_display_in_footer" value="N"<?php if($is_display_in_footer == 'N') { ?> checked = "checked" <?php } ?>>
			<label for="N">No</label><br>
	...
	<div class="col-md-6">
		  <div class="form-group">
			...
			<input type="number" class="form-control" id="display_sequence_number" name="display_sequence_number" value="<?= $display_sequence_number;?>">
  ...
  <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/view-cms-page'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
</form>
</div>
</div>
</div>
