	    ...
	    <section class="photo-gallery">
			<div class="row magnific-gallery">
					...
					<?php 
						...
						<a href="#">
							<figure>
								<img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" data-src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" alt="" class="lazy">
							</figure>
						</a>
					</div>
	    ...
	    <section>
	        <div class="detail_page_head clearfix">
					<div class="title">
						<ul>
							<?php
							foreach($dataFromAddressRestaurant as $ress) {  
								?>
							<li>					
									<h1><?=$ress['restaurant_name']; ?></h1>
									<p><?=$ress['restaurant_street']; ?></p>
									<p><?=$ress['restaurant_pincode']; ?></p>
									<p><?=$ress['restaurant_city']; ?></p>
							<?php
							foreach($dataFromRestaurantTime as $ress) {  
								?>
								<p><?=$ress['timing_day']; ?></p>
								<p><span><?=$ress['restaurant_start_time']; ?></span><br/></p>
								<p><span><?=$ress['restaurant_end_time']; ?></span><br/></p>
							</li>	
