...
$this->title = 'Edit Restaurants Address';
    ...
    <div class="container-fluid">
      ...
      <div class="box_general padding_bottom">
        <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Edit Restaurants Address</h2>
        </div>
 ...
 <?= $this->render('logged_in_user_restaurants', [
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_latitude" name="restaurant_latitude" value="<?= $restaurant_latitude; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_longitude" name="restaurant_longitude" value="<?= $restaurant_longitude; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_street" name="restaurant_street" value="<?= $restaurant_street; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_house_no" name="restaurant_house_no" value="<?= $restaurant_house_no; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_pincode" name="restaurant_pincode" value="<?= $restaurant_pincode; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
		   ...
		   <input type="text" class="form-control" id="restaurant_district" name="restaurant_district" value="<?= $restaurant_district; ?>">
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="txt" class="form-control" id="restaurant_city" name="restaurant_city" value="<?= $restaurant_city; ?>">
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_country" name="restaurant_country" value="<?= $restaurant_country; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_telephone_no" name="restaurant_telephone_no" value="<?= $restaurant_telephone_no; ?>">
    ...
    <div class="col-md-6">
			 <div class="form-group">
				...
				<input type="text" class="form-control" id="restaurant_fax_no" name="restaurant_fax_no" value="<?= $restaurant_fax_no; ?>">
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_mobile_no" name="restaurant_mobile_no" value="<?= $restaurant_mobile_no; ?>">
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_contact_person_name" name="restaurant_contact_person_name" value="<?= $restaurant_contact_person_name; ?>">
    ...
    <div class="col-md-6">
			 <div class="form-group">
				...
				<input type="email" class="form-control" id="restaurant_email" name="restaurant_email" value="<?= $restaurant_email; ?>">
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="restaurant_website" name="restaurant_website" value="<?= $restaurant_website; ?>">
    ...
    <div class="col-md-6">
			 <div class="form-group">
				...
				<input type="text" class="form-control" id="restaurant_rating" name="restaurant_rating" value="<?= $restaurant_rating; ?>">
  ...
  <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/view-restaurant-address'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
</form>
</div>
</div>
</div>
