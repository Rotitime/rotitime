...
$this->title = 'Add Home Pages Sections';
    ...
    <div class="container-fluid">
      ...
      <div class="box_general padding_bottom">
        <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Add Home Pages Sections</h2>
        </div>
		
		
 <form  method="post" enctype="multipart/form-data"  id="addHomePageForm" name="addhomepageform">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="section_display_sequence_number" name="section_display_sequence_number">
  ...
  <button type="button" class="btn btn-default btn_1 medium" id = "submitbutton">submit</button>
  <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/add-home-pages-sections'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
</form>
</div>
</div>
</div>
