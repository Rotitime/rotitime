	...
	<div class="container">
		...
		<div class="row magnific-gallery">
					<div class="col-sm-12 col-md-8">
						...
						?>
						<figure>
							<img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" data-src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" alt="" class="img-fluid">
						</figure>
					</div>
			        <div class="col-sm-2 blocks">
						<figure>
							<img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" data-src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" alt="" class="img-gallery">
						</figure>
