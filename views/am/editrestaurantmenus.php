 ...
 <?= $this->render('logged_in_user_restaurants', [
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="hidden" name="menu_name_hidden" id="menu_name_hidden" value="<?= $menu_name;?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="menu_type" name="menu_type" value="<?= $menu_type; ?>">
    ...
    <div class="col-md-6">
		  <div class="form-group">
		   ...
		   <input type="file" name="menu_image" id="menu_image" value="<?= $menu_image;?>">
		   <input type="hidden" name="menu_image_hidden" id="menu_image_hidden" value="<?= $menu_image;?>">
		   <input type="hidden" name="menu_image_type" id="menu_image_type" value="edit">
		   <figure class="upload-img">
		 <img src="<?= 'http://zefasa.com/rotitime/web/'.$menu_image; ?>" data-src ="<?= 'http://zefasa.com/rotitime/web/'.$menu_image; ?>">
		 </figure>
		   <div>
			Image size: 800*600
		   </div>
    ...
    <div class="col-md-6">
		 <div class="form-group">
			...
			<input type="txt" class="form-control" id="menu_image_alt_text" name="menu_image_alt_text" value="<?= $menu_image_alt_text; ?>">
		  </div>
		  </div>
		 ...
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="menu_image_title_text" name="menu_image_title_text" value="<?= $menu_image_title_text; ?>">
		  </div>
    </div>
    ...
    <div class="col-md-6">
	 ...
	 <div class="col-md-6">
		  <div class="form-group">
			...
			<input type="number" class="form-control" id="menu_display_sequence_number" name="menu_display_sequence_number" value="<?= $menu_display_sequence_number; ?>">
  ...
  <button type="button" class="btn btn-default btn_1 medium" id ="menuedit">submit</button>
     <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/view-restaurant-menus'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
