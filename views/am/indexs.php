...
<main>
			...
			<div class="main_title">
				...
				<h2>Dishes</h2>
					...
					<?php foreach($queryResult as $res) { ?>
								...
								<figure>
							   <img src="<?php echo 'http://zefasa.com/rotitime/web/img'.$res['section_image']; ?>" data-src="<?php echo 'http://zefasa.com/rotitime/web/img'.$res['section_image']; ?>" alt="<?php echo $res['section_image_alt_text_english']; ?>" class="owl-lazy" title="<?php echo $res['section_image_title_text_english	']; ?>">
							   <div class="info">
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/location_1.jpg" data-src="img/location_1.jpg" alt="" class="owl-lazy">
							<div class="info">
		...
		<div class="container margin_60_40">
			...
			<div class="owl-carousel owl-theme categories_carousel">
					<div class="owl-carousel owl-theme categories_carousel">
					<?php foreach($dataFromHomePageSectionExplore as $res) { ?>
								<div class="item_version_2">
								<a href="<?php echo $res['section_image_link']; ?>">
								<figure>
							   <img src="<?php echo 'http://zefasa.com/rotitime/web/img/'.$res['section_image']; ?>" data-src="<?php echo 'http://zefasa.com/rotitime/web/img/'.$res['section_image']; ?>" alt="<?php echo $res['section_image_alt_text_english']; ?>" class="owl-lazy" title="<?php echo $res['section_image_title_text_english']; ?>">
