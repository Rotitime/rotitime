...
?>
	...
	<form method="POST" method="post" enctype="multipart/form-data" id="editOwnerForm" name="editownerform">
		...
		<input type="email" class="form-control" id="owner_email" name="owner_email" value="<?= $owner_email;?>">
	    <input type="hidden" name="owner_email_hidden" id="owner_email_hidden" value="<?= $owner_email;?>">
		...
		<input type="text" class="form-control" id="owner_first_name" name="owner_first_name" value="<?= $owner_first_name;?>">
		...
		<input type="text" class="form-control" id="owner_last_name" name="owner_last_name" value="<?= $owner_last_name;?>">
		...
		<input type="password" class="form-control" id="password_encrypted" name="password_encrypted" value="<?= $password_encrypted;?>">
		...
		<input type="text" class="form-control" id="owner_note" name="owner_note"  value="<?= $owner_note;?>">
   ...
   <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/view-restaurant-owner'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
