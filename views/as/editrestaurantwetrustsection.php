...
$this->title = 'Edit Restaurant We Trust Section';
...
?>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Restaurant We Trust Section</li>
      </ol>

      <div class="box_general padding_bottom">
        <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Edit Restaurant We Trust Section</h2>
        </div>
			  
			  <form  method="post" id="editRestaurantWeTrustForm" name="editrestaurantwetrustform">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="we_trust_title" name="we_trust_title" value="<?= $we_trust_title; ?>">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="we_trust_type" name="we_trust_type" value="<?= $we_trust_type; ?>">
			  ...
			  <div class="form-group">
				...
				<input type="number" class="form-control" id="we_trust_sequence_number" name="we_trust_sequence_number" value="<?= $we_trust_sequence_number; ?>">
		        <input type="hidden" name="we_trust_sequence_number_hidden" id="we_trust_sequence_number_hidden" value="<?= $we_trust_sequence_number;?>">
				  ...
				  <div class="invalid-feedback" id="we_trust_sequence_number_greaterthan">
			 ...
			 <input id="form-token-do" type="hidden" name="<?= Yii::$app->request->csrfParam ?>" value="<?= Yii::$app->request->csrfToken ?>"/>
				 ...
				 <button type="button" class="btn btn-default btn_1 medium" id ="editrestaurantwetrust">Submit</button>
              <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/view-restaurant-we-trust-section'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
