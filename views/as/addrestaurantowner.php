...
?>
		...
		<div class="container-fluid">
		  ...
		  <ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Add Restaurant Owner</li>
		  </ol>

		  <div class="box_general padding_bottom">
			<div class="header_box version_2">
				<h2><i class="fa fa-file"></i>Add Restaurant Owner</h2>
			</div>


	<form method="POST" method="post" enctype="multipart/form-data" id="addOwnerForm" name="addownerform">
   ...
   <button type="button" class="btn btn-default btn_1 medium" id = "ownersubmitbutton">submit</button>
   <a href="<?= Yii::$app->homeUrl.'/'.$controllerName.'/add-restaurant-owner'; ?>" id="cancel" name="cancel" class="btn btn-default btn_1 gray medium">Cancel</a>
