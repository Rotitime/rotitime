...
$this->title = 'Add Home Page Section Image';
...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add Home Page Section Image</li>
      </ol>

      <div class="box_general padding_bottom">
        <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Add Home Page Section Image</h2>
        </div>


 <form method="POST" enctype="multipart/form-data" id="addHomePageImageForm" name="addhomepageimageform">
 ...
 <div class="form-group">
    ...
    <input type="txt" class="form-control" id="section_image_text" name="section_image_text">
 ...
 <label for="section_image_sequence_number">Section Category:</label>
  <div class="styled-select">
                        <select id="section_category" name="section_category">
                            ...
                            <option  value='city-dist'>City - Dist</option>
                        </select>
                    </div>
<div class="invalid-feedback" id="section_category_validation">
 ...
 <div class="form-group">
    ...
    <input type="number" class="form-control" required   id="section_image_sequence_number" name="section_image_sequence_number">
   ...
   <button type="button" class="btn btn-default btn_1 medium" id = "submitbuttonimage">submit</button>
