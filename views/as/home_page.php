...
<main>
		...
		<div class="container margin_30_40">
			...
			<div class="owl-carousel owl-theme categories_carousel">
					<?php foreach($dataFromHomePageSectionDishes as $res) { ?>
					 <div class="item_version_2">
					   <a href="<?php echo $res['section_image_link']; ?>">
					    <figure>
					    <img src="<?php echo 'http://zefasa.com/rotitime/web'.$res['section_image']; ?>" data-src =<?php echo 'http://zefasa.com/rotitime/web'.$res['section_image']; ?> alt="<?php echo $res['section_image_alt_text_english']; ?>" class="owl-lazy" title="<?php echo $res['section_image_title_text_english']; ?>">
					     <div class="info">
					<h3><?php echo $res['section_title_english']; ?></h3>
					    </div>
					   </figure>
					   </a>
					</div>
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/location_1.jpg" data-src="img/location_1.jpg" alt="Text" class="owl-lazy" title="altText">
							<div class="info">
								<h3>Biryani</h3>
							</div>
						</figure>							
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="http://localhost/basic_test/web/img/location_2.jpg" data-src="http://localhost/basic_test/web/img/location_2.jpg" alt="" class="owl-lazy">
							<div class="info">
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/lazy-placeholder.png" data-src="img/location_3.jpg" alt="" class="owl-lazy">
							<div class="info">
								<h3>Tandoor</h3>
							</div>
						</figure>							
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/lazy-placeholder.png" data-src="img/location_4.jpg" alt="" class="owl-lazy">
							<div class="info">
								<h3>Dosa</h3>
							</div>
						</figure>							
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/lazy-placeholder.png" data-src="img/location_5.jpg" alt="" class="owl-lazy">
							<div class="info">
								<h3>Biryani</h3>
							</div>
						</figure>							
				...
				<div class="item_version_2">
					<a href="#">
						<figure>
							<img src="img/lazy-placeholder.png" data-src="img/location_6.jpg" alt="" class="owl-lazy">
							<div class="info">
								<h3>Butter Chicken</h3>
							</div>
						</figure>							
