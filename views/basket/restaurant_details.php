...
<div class="container">
		...
		<section class="photo-gallery">
			<div class="row magnific-gallery">
									<?php foreach($dataFromRestaurantImages as $res) { ?>
	
					<div class="col-sm-12 col-md-8">
						<a href="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" title="Photo title" data-effect="mfp-zoom-in"><img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" class="img-fluid" /></a>
					</div>
					<div class="col-sm-2 blocks">
						<a href="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" title="Photo title" data-effect="mfp-zoom-in"><img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" class="img-gallery"/></a>
						<a href="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" title="Photo title" data-effect="mfp-zoom-in"><img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" class="img-gallery"/></a>						
					</div>
					<div class="col-sm-2 blocks">
						<a href="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" title="Photo title" data-effect="mfp-zoom-in"><div class="bg-btn"><p>View Gallery</p></div><img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" class="img-gallery"/></a>
						<a href="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" title="Photo title" data-effect="mfp-zoom-in"><img src="<?php echo 'http://zefasa.com/rotitime/web/'.$res['restaurants_gallery_image']; ?>" class="img-gallery"/></a>
					</div>
							<?php }?>					
						...
						<div id="pane-A" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-A">
							...
							<div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
								<div class="card-body info_content">
									...
									<?php foreach($dataFromRestaurantDishes as $res){ ?>
										<tbody>
										<tr>
											...
											<td class="options">
												<input type="number" value="" min="0" max="100" step="1"/>
											</td>
										</tr>																				
										</tbody>
									<?php } ?>
