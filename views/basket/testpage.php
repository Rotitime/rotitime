		...
		<section class="photo-gallery">
			<div class="row magnific-gallery">
					...
					<div class="col-sm-12 col-md-8">
						<a href="http://zefasa.com/rotitime/web/" title="Photo title" data-effect="mfp-zoom-in"><img src="http://zefasa.com/rotitime/web/".$restaurantImages['restaurants_gallery_image']; class="img-fluid" /></a>
					</div>
					<div class="col-sm-2 blocks">
						<a href="http://zefasa.com/rotitime/web/" title="Photo title" data-effect="mfp-zoom-in"><img src="http://zefasa.com/rotitime/web/".$restaurantImages['restaurants_gallery_image']; class="img-gallery"/></a>
						<a href="http://zefasa.com/rotitime/web/" title="Photo title" data-effect="mfp-zoom-in"><img src="http://zefasa.com/rotitime/web/".$restaurantImages['restaurants_gallery_image']; class="img-gallery"/></a>						
					</div>
					<div class="col-sm-2 blocks">
						<a href="http://zefasa.com/rotitime/web/" title="Photo title" data-effect="mfp-zoom-in"><div class="bg-btn"><p>View Gallery</p></div><img src="http://zefasa.com/rotitime/web/".$restaurantImages['restaurants_gallery_image']; class="img-gallery"/></a>
						<a href="http://zefasa.com/rotitime/web/" title="Photo title" data-effect="mfp-zoom-in"><img src="http://zefasa.com/rotitime/web/".$restaurantImages['restaurants_gallery_image']; class="img-gallery"/></a>
					</div>	
               <?php
		...
		<section>
			<div class="detail_page_head clearfix">
				...
				<?php
				    ?>
                <li>					
					    <h1><?=$restaurantAddress['restaurant_name']; ?></h1>
						<p><?=$restaurantAddress['restaurant_street']; ?></p>
						<p><?=$restaurantAddress['restaurant_pincode']; ?></p>
						<p><?=$restaurantAddress['restaurant_city']; ?></p> 
				
					<p><?=$restaurantTime['timing_day']; ?></p>
					<p><span><?=$restaurantTime['restaurant_start_time']; ?></span><br/></p>
					<p><span><?=$restaurantTime['restaurant_end_time']; ?></span><br/></p>
				</li>	
					...
					<?php 
						...
						<li>
							<div class="rating">
								...
								<strong><?php echo $restaurantAddress["restaurant_rating"]; ?></strong>
							</div>							
		...
		<div class="row">
			<div class="col-lg-8">
				...
				<div class="tabs_detail">
					...
					<div class="tab-content" role="tablist">
			            ...
			            <form method="post" id="target" action="?action=add&dish_id=<?php echo $res["dish_id"]; ?>">
								<div>
					
									<input type="text" name="quantity" value="1" class="form-control" />

									<h4><input type="hidden" name="hidden_name" value="<?php echo $res["dish_name"]; ?>" /></h4>

									<strong><input type="hidden" name="hidden_price" value="<?php echo $res["dish_price"]; ?>" /></strong>
				 	            
													<h4><?php echo $res["dish_name"]; ?></h4>
													<p>
														<?php echo $res["dish_allergy_text"]; ?>
													</p>
													<strong><?php echo $res["dish_price"]; ?></strong>
																										
											</td>
		                        
										<td class="options">
									<input type="submit" name="add_to_cart"  class="options add-card" value="Add to Cart" />
											</td>
								 </div>
								</div>
									</tr>	
			...
			<!-- /col -->
					...
					foreach($results as $res){
						if(isset($_POST["add_to_cart"]))
						{
							...
							{
								$item_array_id = array_column($_SESSION["shopping_cart"], "dish_id");
								if(!in_array($_GET["dish_id"], $item_array_id))
								{
									$count = count($_SESSION["shopping_cart"]);
									$item_array = array(
										'dish_id'			=>	$_GET["dish_id"],
										'dish_name'			=>	$_POST["hidden_name"],
										'dish_price'		=>	$_POST["hidden_price"],
						...
						if(isset($_GET["action"]))
						{
							if($_GET["action"] == "delete")
							{
								...
								{
									if($values["dish_id"] == $_GET["dish_id"])
									{
			...
			<div class="col-lg-4" id="sidebar_fixed">
				<div class="box_booking">
					...
					<div class="main">
						<ul class="clearfix">
						<li><p><?php echo $values["dish_name"]; ?></p><p><span class="add"><input type="number" name="quantity" class ="add-card" value="<?php echo $values["item_quantity"]; ?>" min="0" max="100" step="1"/></span><span><?php echo $values["dish_price"]; ?></span><a href="?action=delete&dish_id=<?php echo $values["dish_id"]; ?>" id="other"></a></p></li>
					 <?php
					$total = $total + ($values["item_quantity"] * $values["dish_price"]);
