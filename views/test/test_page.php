		...
		<div class="hero_single version_2">
			...
			<div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
							<a rel="nofollow" href="https://restaurant-guru.in/search/best-restaurants-nearby-b" class="search_nearby nearby_link"><i class="fas fa-location-arrow"></i>Use my precise location</a> 
						</div>
					</div>
				</div>
			</div>
