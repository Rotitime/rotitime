...
!(function (e, t) {
            ...
            for ("boolean" == typeof s && ((c = s), (s = arguments[a] || {}), a++), "object" == typeof s || _(s) || (s = {}), a === l && ((s = this), a--); a < l; a++)
                if (null != (e = arguments[a]))
                    for (t in e)
                        (n = s[t]),
                            s !== (i = e[t]) &&
                                (c && i && (T.isPlainObject(i) || (r = Array.isArray(i))) ? ((o = r ? ((r = !1), n && Array.isArray(n) ? n : []) : n && T.isPlainObject(n) ? n : {}), (s[t] = T.extend(c, o, i))) : void 0 !== i && (s[t] = i));
            return s;
        }),
        T.extend({
    ...
    var f = (function (n) {
        ...
        (x = oe.setDocument = function (e) {
            ...
            return (
                i !== E &&
                    ...
                    (C = !s(E)),
                    _ !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)),
                    ...
                    (f.getElementsByClassName = G.test(E.getElementsByClassName)),
                    (f.getById = le(function (e) {
                        return (a.appendChild(e).id = T), !E.getElementsByName || !E.getElementsByName(T).length;
                    })),
                    f.getById
                    ...
                    (u = []),
                    (m = []),
                    (f.qsa = G.test(E.querySelectorAll)) &&
                        (le(function (e) {
                            (a.appendChild(e).innerHTML = "<a id='" + T + "'></a><select id='" + T + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                ...
                                e.querySelectorAll("[selected]").length || m.push("\\[" + z + "*(?:value|" + M + ")"),
                    ...
                    (f.matchesSelector = G.test((v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector))) &&
                        le(function (e) {
                        ...
                        ? function (e, t) {
                              ...
                              return (
                                  ...
                                  (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!f.sortDetached && t.compareDocumentPosition(e) === n)
                                      ? e === E || (e.ownerDocument === _ && y(_, e))
                                          ? -1
                                          : t === E || (t.ownerDocument === _ && y(_, t))
                                          ? 1
                                          : l
                                          ? H(l, e) - H(l, t)
                                          : 0
        ...
        (oe.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== E && x(e), (t = t.replace(K, "='$1']")), f.matchesSelector && C && !I[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t))))
                try {
                    var n = v.call(e, t);
                    ...
                    return 1 === g && 0 === m
                        ...
                        : function (e, t, n) {
                              ...
                              if (u) {
                                  ...
                                  } else if ((d && (f = a = (i = (r = (o = (s = e)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]), !1 === f))
                                      for (
                                          ;
                                          (s = (++a && s && s[c]) || (f = a = 0) || l.pop()) &&
                                          ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((r = (o = s[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, f]), s !== e));
        ...
        function Ee(m, v) {
            function e(e, t, n, i, r) {
                var o,
                    ...
                    g = f.length;
                for (r && (b = t === E || t || r); c !== g && null != (o = f[c]); c++) {
                    if (_ && o) {
                        for (s = 0, t || o.ownerDocument === E || (x(o), (n = !C)); (a = m[s++]); )
                            if (a(o, t || E, n)) {
                                i.push(o);
                                break;
                            }
        ...
        return (
            ...
            (p = oe.tokenize = function (e, t) {
                ...
                for (s = e, a = [], l = w.preFilter; s; ) {
                    ...
                    (n = !1),
                    (i = U.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace($, " ") }), (s = s.slice(n.length))),
                    w.filter))
            ...
            (g = oe.select = function (e, t, n, i) {
                ...
                if (((n = n || []), 1 === u.length)) {
                    ...
                    for (r = Y.needsContext.test(e) ? 0 : o.length; r-- && ((s = o[r]), !w.relative[(a = s.type)]); )
                        if ((l = w.find[a]) && (i = l(s.matches[0].replace(te, h), (ee.test(o[0].type) && ge(t.parentNode)) || t))) {
                            if ((o.splice(r, 1), !(e = i.length && ve(o)))) return P.apply(n, i), n;
                            break;
                        }
                }
                return (c || d(e, u))(i, t, !C, n, !t || (ee.test(e) && ge(t.parentNode)) || t), n;
            }),
    ...
    ((T.fn.init = function (e, t, n) {
        ...
        if (i[1]) {
            if (((t = t instanceof T ? t[0] : t), T.merge(this, T.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), A.test(i[1]) && T.isPlainObject(t))) for (i in t) _(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this;
        }
                        ...
                        s &&
                            ...
                            (function n(e) {
                                T.each(e, function (e, t) {
                                    _(t) ? (i.unique && c.has(t)) || s.push(t) : t && t.length && "string" !== b(t) && n(t);
                                });
                            })(arguments),
                            e && !r && n()),
                        this
                        ...
                        then: function (t, n, i) {
                            ...
                            function c(r, o, s, a) {
                                return function () {
                                            ...
                                            (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                _(t)
                                                    ? a
                                                        ...
                                                        : (l++, t.call(e, c(l, o, H, a), c(l, o, M, a), c(l, o, H, o.notifyWith)))
                                    ...
                                    r ? t() : (T.Deferred.getStackHook && (t.stackTrace = T.Deferred.getStackHook()), E.setTimeout(t));
                                };
                            }
    ...
    (T.fn.ready = function (e) {
        ...
        (T.ready.then = q.then),
        "complete" === C.readyState || ("loading" !== C.readyState && !C.documentElement.doScroll) ? E.setTimeout(T.ready) : (C.addEventListener("DOMContentLoaded", W), E.addEventListener("load", W));
    var F = function (e, t, n, i, r, o, s) {
            var a = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n)) for (a in ((r = !0), n)) F(e, t, a, n[a], !0, o, s);
            else if (
                void 0 !== i &&
                ((r = !0),
                _(i) || (s = !0),
    ...
    function ae(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
            (i = e[o]).style &&
                ((n = i.style.display),
                t
                    ? ("none" === n && ((r[o] = Y.get(i, "display") || null), r[o] || (i.style.display = "")),
                      "" === i.style.display &&
                          re(i) &&
                          (r[o] =
                              ((h = c = l = void 0),
                              (c = (a = i).ownerDocument),
                              (u = a.nodeName),
                              (h = se[u]) || ((l = c.body.appendChild(c.createElement(u))), (h = T.css(l, "display")), l.parentNode.removeChild(l), "none" === h && (h = "block"), (se[u] = h)))))
    ...
    function ve(e, t, n, i, r) {
        ...
        for (h.textContent = "", f = 0; (o = d[f++]); )
            ...
            else if (((c = T.contains(o.ownerDocument, o)), (s = de(h.appendChild(o), "script")), c && fe(s), n)) for (u = 0; (o = s[u++]); ) ue.test(o.type || "") && n.push(o);
        return h;
    }
                ...
                for (
                    ...
                    (f = g = (a = be.exec(e[c]) || [])[1]),
                        ...
                        f &&
                            ...
                            (h = T.event.special[f] || {}),
                            (u = T.extend({ type: f, origType: g, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && T.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
    ...
    function Pe(n, i, r, o) {
        ...
        var e,
            ...
            f = i[0],
            p = _(f);
        if (p || (1 < h && "string" == typeof f && !y.checkClone && Ae.test(f)))
        ...
        if (h && ((t = (e = ve(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (c = s[s.length - 1].ownerDocument, T.map(s, Oe), u = 0; u < a; u++)
                    (l = s[u]), ue.test(l.type || "") && !Y.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && T._evalUrl(l.src) : w(l.textContent.replace(Ie, ""), c, l));
        }
        return n;
    }
    function je(e, t, n) {
    ...
    function Ke() {
        if (Fe) {
            (We.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0"),
                ...
                ye.appendChild(We).appendChild(Fe);
            var e = E.getComputedStyle(Fe);
            (He = "1%" !== e.top),
                (qe = 12 === Qe(e.marginLeft)),
                (Fe.style.right = "60%"),
                (Re = 36 === Qe(e.right)),
                (Me = 36 === Qe(e.width)),
    ...
    function Ve(e, t, n) {
        ...
        return (
            (n = n || Be(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || T.contains(e.ownerDocument, e) || (s = T.style(e, t)),
                !y.pixelBoxStyles() && $e.test(s) && Ue.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function Ye(e, t) {
    ...
    function ot(e, t, n) {
        ...
        return (
            ...
            ("auto" !== r && (parseFloat(r) || "inline" !== T.css(e, "display", !1, i))) || ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = !0)),
    ...
    T.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (r = ne.exec(n)) && r[1] && ((n = oe(e, t, r)), (o = "number")),
                    null != n &&
                        n == n &&
                        ("number" === o && (n += (r && r[3]) || (T.cssNumber[a] ? "" : "px")),
        ...
        T.each(["height", "width"], function (e, a) {
            T.cssHooks[a] = {
                get: function (e, t, n) {
                    if (t)
                        return !Xe.test(T.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? ot(e, a, n)
                            : ee(e, Ge, function () {
                                  return ot(e, a, n);
                              });
                ...
                set: function (e, t, n) {
                    var i,
                        ...
                        s = n && rt(e, a, n, o, r);
                    return (
                        o && y.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - rt(e, a, "border", !1, r) - 0.5)),
                        s && (i = ne.exec(t)) && "px" !== (i[3] || "px") && ((e.style[a] = t), (t = T.css(e, a))),
                        it(0, t, s)
                    );
                },
            };
    ...
    var at,
        ...
        dt = /queueHooks$/;
    function ft() {
        lt && (!1 === C.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(ft) : E.setTimeout(ft, T.fx.interval), T.fx.tick());
    }
    function pt() {
        return (
            E.setTimeout(function () {
    ...
    function vt(o, e, t) {
        ...
        return (
            T.map(u, mt, c),
            _(c.opts.start) && c.opts.start.call(o, c),
    ...
    (T.Animation = T.extend(vt, {
            ...
            function (e, t, n) {
                ...
                if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
                    for (i in (h &&
                        ...
                        "none" === (u = T.css(e, "display")) && (c ? (u = c) : (ae([e], !0), (c = e.style.display || c), (u = T.css(e, "display")), ae([e]))),
        ...
        T.each({ slideDown: gt("show"), slideUp: gt("hide"), slideToggle: gt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, i) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? T.prop(e, t, n)
                        : ((1 === o && T.isXMLDoc(e)) || (r = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? yt : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        T.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s
                    ...
                    : this.each(function () {
                          var e, t, n, i;
                          if (s) for (t = 0, n = T(this), i = Ct(r); (e = i[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                          else (void 0 !== r && "boolean" != o) || ((e = Et(this)) && Y.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : Y.get(this, "__className__") || ""));
                      });
            },
            hasClass: function (e) {
                var t,
                    n,
                    i = 0;
                for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && -1 < (" " + xt(Et(n)) + " ").indexOf(t)) return !0;
                return !1;
            },
        });
    var Tt = /\r/g;
            ...
            if (
                ...
                for (r = 0; (o = d[r++]) && !e.isPropagationStopped(); )
                    (h = o),
                        ...
                        (c = l && o[l]) && c.apply && Q(o) && ((e.result = c.apply(o, t)), !1 === e.result && e.preventDefault());
                return (
                    (e.type = f),
                    i ||
                        ...
                        (l &&
                            ...
                            ((s = n[l]) && (n[l] = null),
                            (T.event.triggered = f),
                            e.isPropagationStopped() && h.addEventListener(f, St),
                            n[f](),
                            e.isPropagationStopped() && h.removeEventListener(f, St),
    ...
    (Ut.href = At.href),
        T.extend({
            ...
            ajax: function (e, t) {
                ...
                if (
                    (_.promise(x),
                    (m.url = ((e || m.url || At.href) + "").replace(Wt, At.protocol + "//")),
                ...
                (h = m.url.replace(Mt, "")),
                m.hasContent
                    ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Ht, "+"))
                    : ((o = m.url.slice(h.length)),
                      m.data && (m.processData || "string" == typeof m.data) && ((h += (kt.test(h) ? "&" : "?") + m.data), delete m.data),
                      !1 === m.cache && ((h = h.replace(zt, "$1")), (o = (kt.test(h) ? "&" : "?") + "_=" + It++ + o)),
                      (m.url = h + o)),
                ...
                x.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : m.accepts["*"]),
                m.headers))
        ...
        T.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                return (
                    ...
                    s ? (e[s] = e[s].replace(Jt, "$1" + i)) : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
                    ...
                    n.always(function () {
                        void 0 === r ? T(E).removeProp(i) : (E[i] = r), e[i] && ((e.jsonpCallback = t.jsonpCallback), Gt.push(i)), o && _(r) && r(o[0]), (o = r = void 0);
                    }),
                    "script"
                );
        }),
        (y.createHTMLDocument = (((Zt = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Zt.childNodes.length)),
        (T.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (r = A.exec(e)) ? [t.createElement(r[1])] : ((r = ve([e], t, o)), o && o.length && T(o).remove(), T.merge([], r.childNodes)));
            var i, r, o;
        }),
    ...
    return (
        (T.noConflict = function (e) {
            return E.$ === T && (E.$ = tn), e && E.jQuery === T && (E.jQuery = en), T;
        }),
        e || (E.jQuery = E.$ = T),
        T
    );
    ...
    (function (e, t) {
        ...
        function m(e, t) {
            g(e, "sizes", s(e, t.data_sizes)), g(e, "srcset", s(e, t.data_srcset)), g(e, "src", s(e, t.data_src));
        }
        function v(e, t) {
            var n = t._settings,
                i = e.tagName,
                    ...
                    function (e) {
                        e.forEach(function (e) {
                            return (function (e) {
                                ...
                                ? (function (e, t) {
                                      var n = t._settings;
                                      d(n.callback_enter, e), n.load_delay ? L(e, t) : N(e, t);
                                  })(e.target, t)
                                : (function (e, t) {
                                      var n = t._settings;
                                      d(n.callback_exit, e), n.load_delay && O(e);
                                  })(e.target, t);
                        });
                    },
                    (function (e) {
        ...
        var S = "was-processed",
            ...
            P = function (e, t, n) {
                var i = t._settings;
                (!n && c(e)) ||
                    (-1 < k.indexOf(e.tagName) && (E(e, t), y(e, i.class_loading)),
                    v(e, t),
                    (function (e) {
                        l(e, S, "true");
                    })(e),
        ...
        return (
            ...
            e &&
                (function (e, t) {
                    if (t)
                        if (t.length) for (var n, i = 0; (n = t[i]); i += 1) r(e, n);
                        else r(e, t);
        ...
        (c.Defaults = {
                ...
                },
                {
                    ...
                    run: function (e) {
                        ...
                        for (e.items = { merge: !1, width: t }; i--; )
                            (n = this._mergers[i]), (n = (this.settings.mergeFit && Math.min(n, this.settings.items)) || n), (e.items.merge = 1 < n || e.items.merge), (o[i] = r ? t * n : this._items[i].width());
                        this._widths = o;
                    },
                },
                {
                            ...
                            l.proxy(function (e, t) {
                                return (
                                    "left" === i && t - 30 < n && n < t + 30
                                        ...
                                        ? (r = e + 1)
                                        : this.op(n, "<", t) && this.op(n, ">", s[e + 1] !== a ? s[e + 1] : t - o) && (r = "left" === i ? e + 1 : e),
                                    -1 === r
                                );
                            }, this)
                        ),
                    this.settings.loop || (this.op(n, ">", s[this.minimum()]) ? (r = n = this.minimum()) : this.op(n, "<", s[this.maximum()]) && (r = n = this.maximum())),
                    r
                );
            }),
            ...
            (c.prototype.coordinates = function (e) {
                ...
                return e === a
                    ...
                    : (this.settings.center ? (this.settings.rtl && ((n = -1), (i = e + 1)), (t = this._coordinates[e]), (t += ((this.width() - t + (this._coordinates[i] || 0)) / 2) * n)) : (t = this._coordinates[i] || 0),
                      (t = Math.ceil(t)));
            }),
            ...
            (n.prototype.thumbnail = function (t, e) {
                function n(e) {
                    '<div class="owl-video-play-icon"></div>',
                        (i = c.lazyLoad ? u("<div/>", { class: "owl-video-tn " + l, srcType: e }) : u("<div/>", { class: "owl-video-tn", style: "opacity:1;background-image:url(" + e + ")" })),
                        t.after(i),
                ...
                if ((t.wrap(u("<div/>", { class: "owl-video-wrapper", style: o })), this._core.settings.lazyLoad && ((a = "data-src"), (l = "owl-lazy")), s.length)) return n(s.attr(a)), s.remove(), !1;
                "youtube" === e.type
                    ...
                    this.core.current() !== this.previous &&
                        (o &&
                            ...
                            n
                                ...
                                .addClass(o)),
                        r && i.one(s.support.animation.end, t).addClass("animated owl-animated-in").addClass(r));
                }
            }),
    ...
    (function (i, r, t) {
        ...
        (n.Defaults = { autoplay: !1, autoplayTimeout: 5e3, autoplayHoverPause: !1, autoplaySpeed: !1 }),
            (n.prototype._next = function (e) {
                (this._call = r.setTimeout(i.proxy(this._next, this, e), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read())),
    ...
    (function (o) {
        ...
        (t.Defaults = {
            ...
            (t.prototype.getPosition = function (e) {
                ...
                return (
                    "page" == i.slideBy
                        ? ((t = o.inArray(this.current(), this._pages)), (n = this._pages.length), e ? ++t : --t, (t = this._pages[((t % n) + n) % n].start))
    ...
    (function (r, e, t, o) {
        ...
        !(function () {
            return !!u("transition");
        })() || ((r.support.transition = new String(h("transition"))), (r.support.transition.end = n.transition.end[r.support.transition])),
            c() && ((r.support.animation = new String(h("animation"))), (r.support.animation.end = n.animation.end[r.support.animation])),
            i() && ((r.support.transform = new String(h("transform"))), (r.support.transform3d = l()));
    })(window.Zepto || window.jQuery, window, document),
    (function (e, t) {
        ...
        p(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', m._handleDismiss(new m())),
        ...
        var v = "button",
            ...
            A = ".active",
            I = ".btn",
            k = { CLICK_DATA_API: "click" + _ + w, FOCUS_BLUR_DATA_API: "focus" + _ + w + " blur" + _ + w },
            N = (function () {
                function n(e) {
                    this._element = e;
                }
        ...
        p(document)
            .on(k.CLICK_DATA_API, T, function (e) {
                e.preventDefault();
                var t = e.target;
                p(t).hasClass(E) || (t = p(t).closest(I)), N._jQueryInterface.call(p(t), "toggle");
            })
                ...
                return (
                    ...
                    (e._addEventListeners = function () {
                        ...
                        this._config.keyboard &&
                            p(this._element).on($.KEYDOWN, function (e) {
                                return t._keydown(e);
                            }),
                    ...
                    (e._addTouchEventListeners = function () {
                        ...
                        if (this._touchSupported) {
                            ...
                            p(this._element.querySelectorAll(te)).on($.DRAG_START, function (e) {
                                ...
                                this._pointerEvent
                                    ? (p(this._element).on($.POINTERDOWN, function (e) {
                                          return n(e);
                                      }),
                                    ...
                                    : (p(this._element).on($.TOUCHSTART, function (e) {
                                          return n(e);
                                      }),
                    ...
                    (e._slide = function (e, t) {
                        ...
                        if (((r = e === R ? ((n = V), (i = Y), W) : ((n = Q), (i = X), F)), l && p(l).hasClass(U))) this._isSliding = !1;
        ...
        var le = "collapse",
            ...
            pe = { SHOW: "show" + ue, SHOWN: "shown" + ue, HIDE: "hide" + ue, HIDDEN: "hidden" + ue, CLICK_DATA_API: "click" + ue + ".data-api" },
            ge = "show",
            me = "collapse",
            ve = "collapsing",
            ye = "collapsed",
                ...
                return (
                    ...
                    (e.show = function () {
                        ...
                        if (
                            ...
                            (this._parent &&
                                0 ===
                                    (e = [].slice.call(this._parent.querySelectorAll(be)).filter(function (e) {
        ...
        p(document).on(pe.CLICK_DATA_API, xe, function (e) {
            ...
            (p.fn[le] = Ee._jQueryInterface),
            (p.fn[le].Constructor = Ee),
            (p.fn[le].noConflict = function () {
                return (p.fn[le] = he), Ee._jQueryInterface;
            });
        for (var Ce = "undefined" != typeof window && "undefined" != typeof document, Te = ["Edge", "Trident", "Firefox"], Se = 0, De = 0; De < Te.length; De += 1)
            if (Ce && 0 <= navigator.userAgent.indexOf(Te[De])) {
                Se = 1;
                break;
            }
        var Ae =
        ...
        var Le = Ce && !(!window.MSInputMethodContext || !document.documentMode),
        ...
        function ze(e, t) {
            ...
            if ((e !== s && t !== s) || i.contains(r))
                return (function (e) {
                    ...
                    : He(s);
            var a = Me(e);
            return a.host ? ze(a.host, t) : ze(e, Me(t).host);
        }
        function Re(e, t) {
        ...
        function We(e, t, n, i) {
            return Math.max(
                ...
                n["offset" + e],
                n["scroll" + e],
                je(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0
            );
        }
        function Fe(e) {
            var t = e.body,
        ...
        function ct() {
            this.state.eventsEnabled &&
                ...
                (this.state = (function (e, t) {
                    return (
                        at(e).removeEventListener("resize", t.updateBound),
        ...
        function dt(e, t) {
            ...
            var i = e.offsets,
                ...
                f = t ? s : n;
            return { left: d(l % 2 == 1 && c % 2 == 1 && !h && t ? r.left - 1 : r.left), top: f(r.top), bottom: f(r.bottom), right: d(r.right) };
        }
        var ft = Ce && /Firefox/i.test(navigator.userAgent);
        function pt(e, t, n) {
            var i = it(e, function (e) {
                    return e.name === t;
                }),
                ...
                modifiers: {
                    ...
                    flip: {
                        ...
                        fn: function (f, p) {
                            ...
                            var g = Ze(f.instance.popper, f.instance.reference, p.padding, p.boundariesElement, f.positionFixed),
                            ...
                            return (
                                _.forEach(function (e, t) {
                                    if (m !== e || _.length === t + 1) return f;
                                    (m = f.placement.split("-")[0]), (v = tt(m));
                                    ...
                                    (o || u || d) &&
                                        ...
                                        (f.placement = m + (y ? "-" + y : "")),
                                        (f.offsets.popper = Ke({}, f.offsets.popper, nt(f.instance.popper, f.offsets.reference, f.placement))),
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var s = void 0 !== o ? o : t.gpuAcceleration,
                                ...
                                u = dt(e, window.devicePixelRatio < 2 || !ft),
                            ...
                            if (
                                ...
                                (c[f] = "translate3d(" + p + "px, " + g + "px, 0)"), (c[h] = 0), (c[d] = 0), (c.willChange = "transform");
                            else {
                                var m = "bottom" == h ? -1 : 1,
                                    v = "right" == d ? -1 : 1;
        ...
        function Ct(e, t) {
            ...
            !(function (e, t) {
                ...
                (this.options = Ke({}, Ct.Defaults, i)),
                (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
                (this.reference = e && e.jquery ? e[0] : e),
                (this.popper = t && t.jquery ? t[0] : t),
                (this.options.modifiers = {}),
                Object.keys(Ke({}, Ct.Defaults.modifiers, i.modifiers)).forEach(function (e) {
                    n.options.modifiers[e] = Ke({}, Ct.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {});
                }),
        ...
        (Et.Utils = ("undefined" != typeof window ? window : global).PopperUtils), (Et.placements = gt), (Et.Defaults = xt);
        var Tt = "dropdown",
            St = "bs.dropdown",
            Dt = "." + St,
            At = ".data-api",
            ...
            Nt = { HIDE: "hide" + Dt, HIDDEN: "hidden" + Dt, SHOW: "show" + Dt, SHOWN: "shown" + Dt, CLICK: "click" + Dt, CLICK_DATA_API: "click" + Dt + At, KEYDOWN_DATA_API: "keydown" + Dt + At, KEYUP_DATA_API: "keyup" + Dt + At },
            Ot = "disabled",
            Lt = "show",
            Pt = "dropup",
            jt = "dropright",
            ...
            Gt = (function () {
                ...
                return (
                                ...
                                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        "parent" === this._config.reference ? (r = e) : g.isElement(this._config.reference) && ((r = this._config.reference), void 0 !== this._config.reference.jquery && (r = this._config.reference[0])),
                                            "scrollParent" !== this._config.boundary && p(e).addClass(zt),
                                            (this._popper = new Et(r, this._menu, this._getPopperConfig()));
                                    }
                                    "ontouchstart" in document.documentElement && 0 === p(e).closest(Ft).length && p(document.body).children().on("mouseover", null, p.noop),
                                        this._element.focus(),
                                        this._element.setAttribute("aria-expanded", !0),
                                        p(this._menu).toggleClass(Lt),
                                        p(e).toggleClass(Lt).trigger(p.Event(Nt.SHOWN, n));
                                }
                            }
                        }
                    }),
                                    ...
                                    if (p(r).hasClass(Lt) && !(e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && 9 === e.which)) && p.contains(r, e.target))) {
                                        ...
                                        p(r).trigger(l),
                                            l.isDefaultPrevented() ||
                                                ...
                                                p(a).removeClass(Lt),
                                                p(r).removeClass(Lt).trigger(p.Event(Nt.HIDDEN, s)));
                                    }
                                }
                            }
                    }),
                    ...
                    (c._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(Wt).length))) : kt.test(e.which)) &&
                            (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Ot))
                        ) {
        ...
        p(document)
            .on(Nt.KEYDOWN_DATA_API, Rt, Gt._dataApiKeydownHandler)
            .on(Nt.KEYDOWN_DATA_API, Wt, Gt._dataApiKeydownHandler)
            .on(Nt.CLICK_DATA_API + " " + Nt.KEYUP_DATA_API, Gt._clearMenus)
            .on(Nt.CLICK_DATA_API, Rt, function (e) {
        ...
        var Jt = "modal",
            ...
            on = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" },
            sn = {
                HIDE: "hide" + tn,
                HIDDEN: "hidden" + tn,
                SHOW: "show" + tn,
            ...
            _n = (function () {
                function r(e, t) {
                    (this._config = this._getConfig(t)),
                        (this._element = e),
                        (this._dialog = e.querySelector(fn)),
                        (this._backdrop = null),
                        (this._isShown = !1),
                ...
                return (
                        ...
                        if (!this._isShown && !this._isTransitioning) {
                            ...
                            p(this._element).trigger(n),
                                this._isShown ||
                                    ...
                                    p(this._element).on(sn.CLICK_DISMISS, mn, function (e) {
                                        return t.hide(e);
                                    }),
                        ...
                        if ((e && e.preventDefault(), this._isShown && !this._isTransitioning)) {
                            ...
                            if ((p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())) {
                                ...
                                if (
                                    ...
                                    p(this._element).removeClass(dn),
                    ...
                    (e._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ? p(this._element).on(sn.KEYDOWN_DISMISS, function (e) {
                    ...
                    (e._setResizeEvent = function () {
                        var t = this;
                        this._isShown
                            ? p(window).on(sn.RESIZE, function (e) {
                    ...
                    (e._showBackdrop = function (e) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                p(this._element).on(sn.CLICK_DISMISS, function (e) {
                                    t._ignoreBackdropClick ? (t._ignoreBackdropClick = !1) : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide());
                                }),
                                n && g.reflow(this._backdrop),
                                p(this._backdrop).addClass(dn),
                                !e)
                            )
                                return;
                            if (!n) return void e();
                    ...
                    (r._jQueryInterface = function (n, i) {
                        return this.each(function () {
                            var e = p(this).data(en),
                                t = l({}, rn, p(this).data(), "object" == typeof n && n ? n : {});
        ...
        p(document).on(sn.CLICK_DATA_API, gn, function (e) {
            ...
            (p.fn[Jt] = _n._jQueryInterface),
            (p.fn[Jt].Constructor = _n),
            (p.fn[Jt].noConflict = function () {
                return (p.fn[Jt] = nn), _n._jQueryInterface;
            });
        var wn = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
            bn = {
                    ...
                    i = function (e, t) {
                        ...
                        r.forEach(function (e) {
                            !(function (e, t) {
                                ...
                                if (-1 !== t.indexOf(n)) return -1 === wn.indexOf(n) || Boolean(e.nodeValue.match(xn) || e.nodeValue.match(En));
                                for (
                ...
                return (
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            p(r).data(this.constructor.DATA_KEY, this),
                                ...
                                (this._popper = new Et(this.element, r, {
                                    placement: a,
                                    modifiers: { offset: this._getOffset(), flip: { behavior: this.config.fallbackPlacement }, arrow: { element: Wn }, preventOverflow: { boundariesElement: this.config.boundary } },
                                    onCreate: function (e) {
                    ...
                    (e.setElementContent = function (e, t) {
                        "object" != typeof t || (!t.nodeType && !t.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (t = Cn(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
                                : e.text(t)
                            : this.config.html
                    ...
                    (e._enter = function (e, t) {
                        ...
                        (t = t || p(e.currentTarget).data(n)) || ((t = new this.constructor(e.currentTarget, this._getDelegateConfig())), p(e.currentTarget).data(n, t)),
                            e && (t._activeTrigger["focusin" === e.type ? $n : Fn] = !0),
                            p(t.getTipElement()).hasClass(Rn) || t._hoverState === jn
                                ? (t._hoverState = jn)
                    ...
                    (e._leave = function (e, t) {
                        var n = this.constructor.DATA_KEY;
                        (t = t || p(e.currentTarget).data(n)) || ((t = new this.constructor(e.currentTarget, this._getDelegateConfig())), p(e.currentTarget).data(n, t)),
                            e && (t._activeTrigger["focusout" === e.type ? $n : Fn] = !1),
                    ...
                    (e._getConfig = function (e) {
                        ...
                        return (
                            ...
                            g.typeCheckConfig(Tn, e, this.constructor.DefaultType),
                            e.sanitize && (e.template = Cn(e.template, e.whiteList, e.sanitizeFn)),
                            e
                        );
                    }),
        ...
        (p.fn[Tn] = Kn._jQueryInterface),
            (p.fn[Tn].Constructor = Kn),
        ...
        var Qn = "popover",
            ...
            Jn = l({}, Kn.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
            ei = l({}, Kn.DefaultType, { content: "(string|element|function)" }),
            ti = "fade",
            ni = "show",
            ii = ".popover-header",
            ri = ".popover-body",
        ...
        (p.fn[Qn] = si._jQueryInterface),
            (p.fn[Qn].Constructor = si),
            ...
            Si = (function () {
                function n(e, t) {
                    ...
                    (this._element = e),
                        ...
                        (this._config = this._getConfig(t)),
                        (this._selector = this._config.target + " " + yi + "," + this._config.target + " " + wi + "," + this._config.target + " " + xi),
                        (this._offsets = []),
                        (this._targets = []),
                        (this._activeTarget = null),
                        (this._scrollHeight = 0),
                        p(this._scrollElement).on(fi.SCROLL, function (e) {
                            return n._process(e);
                        }),
                        this.refresh(),
                        this._process();
                ...
                return (
                    (e.refresh = function () {
                        var t = this,
                            e = this._scrollElement === this._scrollElement.window ? Ci : Ti,
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(pi)
                            ? (n.closest(bi).find(Ei).addClass(gi), n.addClass(gi))
                            : (n.addClass(gi),
                              n
                                  .parents(vi)
                                  .prev(yi + ", " + wi)
                                  .addClass(gi),
                              n.parents(vi).prev(_i).children(yi).addClass(gi)),
                            p(this._scrollElement).trigger(fi.ACTIVATE, { relatedTarget: t });
                    }),
                    (e._clear = function () {
                        [].slice
                            .call(document.querySelectorAll(this._selector))
        ...
        var Di = "bs.tab",
            Ai = "." + Di,
            Ii = p.fn.tab,
            ki = { HIDE: "hide" + Ai, HIDDEN: "hidden" + Ai, SHOW: "show" + Ai, SHOWN: "shown" + Ai, CLICK_DATA_API: "click" + Ai + ".data-api" },
            Ni = "dropdown-menu",
            Oi = "active",
            Li = "disabled",
            Pi = "fade",
            ...
            $i = (function () {
                ...
                return (
                    ...
                    (e._activate = function (e, t, n) {
                        ...
                        var r = this,
                            o = (!t || ("UL" !== t.nodeName && "OL" !== t.nodeName) ? p(t).children(zi) : p(t).find(Ri))[0],
        ...
        p(document).on(ki.CLICK_DATA_API, qi, function (e) {
            ...
            (p.fn.tab = $i._jQueryInterface),
            (p.fn.tab.Constructor = $i),
        ...
        var Bi = "toast",
            ...
            Ki = "." + Ui,
            Qi = p.fn[Bi],
            Vi = { CLICK_DISMISS: "click.dismiss" + Ki, HIDE: "hide" + Ki, HIDDEN: "hidden" + Ki, SHOW: "show" + Ki, SHOWN: "shown" + Ki },
            Yi = "fade",
            Xi = "hide",
            Zi = "show",
            Gi = "showing",
                ...
                return (
                    ...
                    (e.hide = function (e) {
                        ...
                        this._element.classList.contains(Zi) &&
                            (p(this._element).trigger(Vi.HIDE),
                            e
                                ? this._close()
        ...
        (p.fn[Bi] = nr._jQueryInterface),
            (p.fn[Bi].Constructor = nr),
            (p.fn[Bi].noConflict = function () {
    ...
    (function (e) {
        ...
        (e.prototype = {
            ...
            appendContent: function (e, t) {
                (g.content = e) ? (g.st.showCloseBtn && g.st.closeBtnInside && !0 === g.currTemplate[t] ? g.content.find(".mfp-close").length || g.content.append(p()) : (g.content = e)) : (g.content = ""),
                    f("BeforeAppend"),
            ...
            (u.fn.magnificPopup = function (e) {
                ...
                else (e = u.extend(!0, {}, e)), w ? t.data("magnificPopup", e) : (t[0].magnificPopup = e), g.addGroup(t, e);
                return t;
            });
        function x() {
            T && (C.after(T.addClass(E)).detach(), (T = null));
        }
        var E,
            C,
            T,
                ...
                getInline: function (e, t) {
                    if ((x(), e.src)) {
                        ...
                        if (i.length) {
                            ...
                            r && r.tagName && (C || ((E = n.hiddenClass), (C = d(E)), (E = "mfp-" + E)), (T = i.after(C).detach().removeClass(E))), g.updateStatus("ready");
                ...
                getImage: function (e, t) {
                    var n = 0,
                        i = function () {
                            e &&
                                (e.img[0].complete
                                    ? (e.img.off(".mfploader"), e === g.currItem && (g._onImageHasSize(e), g.updateStatus("ready")), (e.hasSize = !0), (e.loaded = !0), f("ImageLoadComplete"))
                                    : ++n < 200
                                    ? setTimeout(i, 100)
                                    : r());
                        },
                    ...
                    return (
                        ...
                        g.resizeImage(),
                        e.hasSize
                            ? (N && clearInterval(N), e.loadError ? (t.addClass("mfp-loading"), g.updateStatus("error", o.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), g.updateStatus("ready")))
        ...
        u.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (e) {
                    var t,
                        n = (t = e ? g.currItem.img : g.st.zoom.opener(g.currItem.el || g.currItem)).offset(),
            ...
            prepareOptions: function (e, t) {
                ...
                if (
                    ...
                    e.enable &&
                        ...
                        !o.isArray(e.toggle.attachToKeyCodes)))
                ) {
            ...
            wrapElement: function (n) {
                ...
                return (
                    this.wrapperElement.length ||
                        ...
                        this.element.css(n.innerElementStyles).wrap(o(n.element).addClass(n.className).css(n.styles)),
            ...
            initToggle: function (e) {
                return (
                    this.toggleElement.length ||
                        ((this.toggleElement = o(e.element).attr(e.attr).addClass(e.className).css(e.styles).appendTo(this.wrapperElement)),
                        this.updateToggle(),
                        this.positionToggle(e.position, e.verticalAlign, e.offset),
                        e.touchSupport ? (this.toggleElement.css(e.touchStyles), this.element.on(e.attachToTouchEvent, o.proxy(this.toggleTouchEvent, this))) : this.toggleElement.on(e.attachToEvent, o.proxy(this.toggleEvent, this)),
