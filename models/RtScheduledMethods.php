...
class RtScheduledMethods extends Model
{
    ...
    public function fnRequestReviewEmailSent()
	{
        ...
        $Message .= 'Test Cron Email';

		$ToEmailId = 'anriys.info@gmail.com';
	...
	{		
		$RtConnDb = RtScheduledMethods::connectDb('rotitime');
		$updateQuery = "update ".DB_ROTITIME.".".RT_RESTAURANT_ORDERS." set `is_request_for_review_email_sent`='Y' WHERE DATE_ADD(now(), INTERVAL 2 HOUR)";
		$queryResult = $RtConnDb
