...
class AdminController extends Controller
{
	...
	public function actionDashboard()
    {
        ...
        $reviewsCnt = $RtReports->fnGetNoOfReviews($startDate, $endDate);
    ...
    public function actionViewReviews()
    {
        ...
        $reviewsWithDuration = $RtReports->fnReviewsWithDuration($startDate, $endDate);
    ...
    public function actionViewRestaurantOrders()
    {
        ...
        $orderedWithinDurationArr = $RtReports->fnOrderedWithinDuration($startDate, $endDate);		
